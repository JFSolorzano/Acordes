    ...
    <div class="row-fluid">
        ...
        <div class="container">
            ...
            <div class = "col-md-8" >
                ...
                <fieldset >
                    {!! Form::text('nombre', $registro['titulo'], array('placeholder'=>'Nombre del Servicio', 'class'=>'text-center form-control')) !!}
                    <br />
                    {!! Form::textarea('descripcion', $registro['descripcion'], array('size' => '30x5','placeholder'=>'Descripcion', 'class'=>'text-center form-control')) !!}
                    <br />
                    {!! Form::text('estado', $registro['estado'], array('size' => '30x5','placeholder'=>'Estado', 'class'=>'text-center form-control')) !!}
                    <br />
