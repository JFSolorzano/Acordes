...
@section('contenido')
    <header class = "main-header" id = "top" >
        ...
        <div class = "logo-container light-shark-bg align-right" >
            <br >
            <h1 class="align-center"><span>EDITAR PROMOCION</span></h1>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 wow fadeInLeft">
                        ...
                        <div class = "col-md-6" >
                            {!! Form::text('nombre', $registro['nombre'], array('placeholder'=>'Nombre de la promocion', 'style'=>'width: 100%')) !!}
                            {!! Form::textarea('descripcion', $registro['descripcion'], array('size' => '30x5','placeholder'=>'Descripcion', 'style'=>'width: 100%')) !!}

                            <div class="form-group text-center">
                                <label>Fecha de Inicio : </label>
                                {!! Form::date('inicio',$registro['inicio'],array('style'=>'width: 100%')) !!}
                            </div>
                            <div class="form-group text-center">
                                <label>Fecha de Fin : </label>
                                {!! Form::date('fin',$registro['fin'],array('style'=>'width: 100%')) !!}
                            </div>
                        </div >
                        </fieldset>
