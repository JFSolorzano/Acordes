    ...
    <div class="row-fluid">
        ...
        <div class="container">
            ...
            <div class = "col-md-8" >
                ...
                <fieldset >
                    {!! Form::text('usuario', null, array('placeholder'=>'Usuario', 'class'=>'text-center form-control')) !!}
                    <br />
                    {!! Form::email('email', null, array('placeholder'=>'Email (Con este se logeara)', 'class'=>'text-center form-control')) !!}
                    <br />
