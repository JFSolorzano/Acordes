...
@section('contenido')
    <header class = "main-header" id = "top" >
        ...
        <div class = "logo-container light-shark-bg align-right" >
            <br >
            <h1 class="align-center"><span>BOCAS</span></h1>
        ...
        <div class = "header-bottom-bar" >
            <div class = "container" >
                <div class = "row" >
                    ...
                    <!-- /col-md-12 -->
                    <div class="col-md-3">
                        {!! Form::open([ 'url'=>'/menu/bocas','method'=>'GET', 'class'=> 'search-form', 'role'=>'search']) !!}
                    ...
                    <tr>
                        ...
                        <td >
                            <div class="btn-group-sm">
                                <a href = "{{url('menu/bocas/'.Hashids::encode($registro->id).'/detalles')}}" ><i class="fa fa-archive"></i></a >
                                <a href = "{{url('menu/bocas/'.Hashids::encode($registro->id).'/editar')}}" ><i class="fa fa-edit"></i></a >
                                <a href = "{{url('menu/bocas/'.$registro->id.'/eliminar')}}" onclick="return confirm('Esta seguro que desea eliminar esta opcion?')" ><i class="fa fa-trash"></i></a >
                            </div>
                        </td>
                    </tr>
                @endforeach
