                ...
                <div class = "row" >
                    <div class = "col-md-12" >
                        <div class = "contact-info align-right" >
                            <ul >
                                <li ><a href = "{{ route('adminMenuCalientes') }}" >VER REGISTROS</a ></li >
                            </ul >
                        </div >
                        <!-- /contact-info -->
                    </div >
                        ...
                        <div class="col-md-6 wow fadeInRight">
                            ...
                            <div class="food-tags-category">
                                <div class="food-category">
                                    <h6>Categoria: </h6>
                                    <ul>
                                        <li><a href="{{ url('/menu/bebidas-calientes') }}">{{ $registro -> menu }}</a></li>
                                    </ul>
                                </div><!-- /category -->
                                <div class="food-category">
                                    <h6>Acciones: </h6>
                                    <ul>
                                        <li><a href = "{{url('menu/bebidas-calientes/'.Hashids::encode($registro->id).'/editar')}}" >Editar Registro</a ></li>
                                    </ul>
                                </div><!-- /category -->
