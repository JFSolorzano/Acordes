        ...
        <div class = "container" >
            <div class = "row" >
                ...
                <div class = "col-md-12 wow fadeInLeft" >
                    ...
                    <div class = "col-md-6" >
                        <fieldset >
                            {!! Form::text('nombre', null, array('placeholder'=>'Nombre', 'style'=>'width: 100%')) !!}
                            {!! Form::text('extra', null, array('placeholder'=>'Extra', 'style'=>'width: 100%')) !!}
                            ...
                            <div class = "align-right" >
                                <span >Costo:  </span ><span >$</span ><input type = "number" name = "costo"
                                                                              value = "0" >
                            </div >
