...
@section('content')
    ...
    <div class="row-fluid">
        ...
        <div class="container">
            ...
            <div class = "col-md-8" >
                {!! Form::open(['url'=>'menu-bar/'.$datos->id.'/actualizar','autocomplete'=>'off','files'=>'true']) !!}
                <fieldset >
                    ...
                    <br />
                    {!! Form::textarea('descripcionCompleta', $datos->descripcionCompleta, array('size' => '30x5','placeholder'=>'Descripcion Completa', 'class'=>'text-center form-control')) !!}
                    <br />
