...
@section('contenido')
    <header class = "main-header" id = "top" >
        ...
        <div class = "logo-container light-shark-bg align-right" >
            <br >
            <h1 class="align-center"><span>PARA PICAR</span></h1>
        ...
        <div class = "header-bottom-bar" >
            <div class = "container" >
                <div class = "row" >
                    <div class = "col-md-9" >
                        <div class = "contact-info align-right" >
                            <ul >
                                ...
                                <li ><a href = "{{ route('PicarReport') }}" target="_blank" >IMPRIMIR</a ></li >
                    ...
                    <!-- /col-md-12 -->
                    <div class="col-md-3">
                        {!! Form::open([ 'url'=>'/menu/para-picar','method'=>'GET', 'class'=> 'search-form', 'role'=>'search']) !!}
                    ...
                    <tr>
                        ...
                        <td >
                            <div class="btn-group-sm">
                                <a href = "{{url('menu/para-picar/'.Hashids::encode($registro->id).'/detalles')}}" ><i class="fa fa-archive"></i></a >
                                <a href = "{{url('menu/para-picar/'.Hashids::encode($registro->id).'/editar')}}" ><i class="fa fa-edit"></i></a >
                                <a href = "{{url('menu/para-picar/'.$registro->id.'/eliminar')}}" onclick="return confirm('Esta seguro que desea eliminar esta opcion?')" ><i class="fa fa-trash"></i></a >
                            </div>
                        </td>
                    </tr>
                @endforeach
