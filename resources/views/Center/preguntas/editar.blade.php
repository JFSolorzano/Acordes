...
@section('contenido')
    <header class = "main-header" id = "top" >
        ...
        <div class = "logo-container light-shark-bg align-right" >
            ...
            <h1 class = "align-center" ><span >EDITAR PREGUNTA</span ></h1 >
            ...
            <div class = "row" >
                ...
                <div class = "col-md-12 wow fadeInLeft" >
                    ...
                    <div class = "col-md-8 col-md-offset-2" >
                        <fieldset >
                            {!! Form::text('pregunta', $registro->pregunta, array( 'placeholder'=>'Pregunta', 'style'=>'width: 100%')) !!}
                            {!! Form::textarea('respuesta', $registro->respuesta, array('size' => '30x5', 'placeholder'=>'Respuesta', 'style'=>'width: 100%')) !!}
                        </fieldset >
                    </div >
