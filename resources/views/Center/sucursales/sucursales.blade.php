                ...
                <div class="row">
                    ...
                    <div class = "col-md-4" >
                        <div class="pull-right">
                            {!! Form::open([ 'route'=>'sucursales','method'=>'GET', 'class'=> 'navbar-form navbar-left','role'=>'search']) !!}
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group-sm">
                                <a href = "{{url('sucursales/'.$d->id.'/editar')}}" class="btn btn-warning"><i class="fa fa-edit"></i></a >
                                <a href = "{{url('sucursales/'.$d->id.'/eliminar')}}" onclick="return confirm('Esta seguro que desea eliminar este dato')" class="btn btn-danger"><i class="fa fa-trash"></i></a >
                            </div>
                            <br />
