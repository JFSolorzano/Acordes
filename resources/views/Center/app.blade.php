        ...
        <div class = "collapse navbar-collapse pull-right" id = "bs-example-navbar-collapse-1" >
            @unless(Auth::guest())
                <ul class = "nav navbar-nav" >
                    ...
                    @if(Entrust::can('crud-menu'))
                        <li class = "dropdown" >
                            ...
                            <ul class = "dropdown-menu" role = "menu" >
                                <li ><a href = "{{ route('adminMenuRestaurante') }}" >Bar</a ></li >
                                <li class = "divider" ></li >
                                <li ><a href = "{{ route('adminMenuRestaurante') }}" >Restaurante</a ></li >
                            </ul >
                        </li >
                        <li class = "divider" ></li >
                    @endif
                    <li class = "dropdown" >
                        <a href = "#" class = "dropdown-toggle" data-toggle = "dropdown" role = "button"
                           aria-expanded = "false" >Control de Contenido<span class = "caret" ></span ></a >
                        <ul class = "dropdown-menu" role = "menu" >
                    ...
                    <li class = "dropdown" >
                        ...
                        <ul class = "dropdown-menu" role = "menu" >
                            @if(Entrust::can('crud-usuarios'))
                                <li ><a href = "{{ route('adminRegistrar') }}" >Registrar Usuario</a ></li >
                                <li class = "divider" ></li >
                            @endif
                            <li ><a href = "{{ route('adminSalir') }}" >Cerrar Sesion</a ></li >
                        </ul >
                    </li >
                @endif
            </ul >
