...
@section('contenido')
    <header class = "main-header" id = "top" >
        ...
        @endif
            <div class = "logo-container light-shark-bg align-right" >
                <br >
                <h1 class="align-center"><span>NUEVO USUARIO</span></h1>
    ...
    <section class="reservation">
        <div class="container">
            <div class="row">
                {!! Form::open(['route'=>'adminPostEmpleadosCrear','autocomplete'=>'off', 'files'=>'true']) !!}
                <div class="col-md-12 wow fadeInLeft">
                    ...
                    <div class = "col-md-6" >
                        <fieldset >
                            ...
                            <br />
                            {!! Form::text('email', null, array( 'placeholder'=>'Email', 'autocomplete'=>'off', 'style'=>'width: 100%')) !!}
                            <br />
                            <input type = "password" name="password" autocomplete="off" required placeholder="Contrasena" style="width: 100%" >
                            <br >
                            <input type = "password" name="password_confirmation" required placeholder="Confirma tu Contrasena" style="width: 100%">
