        ...
        <div class="row">
            <div class="col-md-3 align-center">
                <div class="logo-container wow fadeInLeft">
                    <a href="#">
                        <img src="{{ asset('club/img/logo/logo-light-blue.png') }}" alt="Marine Food Logo">
                    </a>
                </div><!-- /logo-container -->
            ...
            <div class="col-md-6 wow fadeInDown">
                <div class="contact-form-contaienr">
                    ...
                    <form id="contact-form" method="post" action="http://gourmet.arenaofthemes.com/php/contact.php">
            ...
            <div class="col-md-3 wow fadeInRight">
                <div class="address-container">
                    <address>
                        <img src="{{ asset('club/img/template-assets/map-pin.png') }}" alt="Marine Food Address">
                        <p>
                        ...
                        <img src="{{ asset('club/img/template-assets/phone-icon.png') }}" alt="Marine Food Address">
                        <p>
                            <span>Phone: (415) 124-5678</span>
                            <span>Fax: (415) 124-5678</span>
                        </p>
                        <img src="{{ asset('club/img/template-assets/mail-icon2.png') }}" alt="Marine Food Address">
                        <p>
